...
Kaya includes support for Max Mega Menu, WS Form, Fluent Forms, Elementor Page Builder, Gutenberg, GenerateBlocks, and WP Bakery.
...
= 3.4.1 - Jul 19 2026 =
* Update: woocommerce sets the <del> to opacity .7, reset it to 1 to pass color contrast.
* Update: improve the author url fetch on the author bio at the end of blog posts.
...
* Add: CSS support for WS Form.
* Add: icons to indicate when a menu has a submenu.
...
* Fix: blog page fixed to properly only display h1 when no hero.
...
= 3.0.6 - Aug 22 2025 = 
* Update: fix updater for semantic versioning compare.

= 3.0.5 - Aug 19 2025 =
* Update: fix updater for github to target template instead of stylesheet.
