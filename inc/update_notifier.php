...
function update_notifier_menu() {  
	...
	$theme_data = wp_get_theme(TEMPLATEPATH . '/style.css'); // Get theme data from style.css (current version is what we want)
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'https://www.anphira.com/notifier.xml';
