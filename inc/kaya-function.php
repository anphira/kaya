...
function kaya_display_social_sharing() {
	...
	<div class="social-sharing-buttons">
		<span><?php echo esc_html(get_theme_mod( 'kaya_social_sharing_text', 'Enjoy the article? Share it: ')); ?></span>

		<!-- Sharingbutton Facebook -->
		<?php if(get_theme_mod( 'kaya_social_sharing_facebook', false)) : ?>
		<a class="resp-sharing-button__link resp-sharing-button--facebook" href="https://facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_the_permalink()); ?>" target="_blank" rel="noopener" aria-label="Facebook">
		  <div class="resp-sharing-button resp-sharing-button--medium"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
		...
		<a class="resp-sharing-button__link resp-sharing-button--twitter" href="https://twitter.com/intent/tweet/?text=<?php echo urlencode(get_the_title()); ?>&amp;url=<?php echo urlencode(get_the_permalink()); ?>" target="_blank" rel="noopener" aria-label="Twitter">
		  <div class="resp-sharing-button resp-sharing-button--medium"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
		...
		<a class="resp-sharing-button__link resp-sharing-button--pinterest" href="https://pinterest.com/pin/create/button/?url=http%3A%2F%2Fsharingbuttons.io&amp;media=<?php echo urlencode(get_the_permalink()); ?>&amp;description=<?php echo urlencode(get_the_title()); ?>" target="_blank" rel="noopener" aria-label="Pinterest">
		  <div class="resp-sharing-button resp-sharing-button--medium"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
		...
		<a class="resp-sharing-button__link resp-sharing-button--linkedin" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo urlencode(get_the_permalink()); ?>&amp;title=<?php echo urlencode(get_the_title()); ?>&amp;summary=<?php echo urlencode(get_the_title()); ?>&amp;source=<?php echo urlencode(get_the_permalink()); ?>" target="_blank" rel="noopener" aria-label="LinkedIn">
		  <div class="resp-sharing-button resp-sharing-button--medium"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
		...
		<a class="resp-sharing-button__link resp-sharing-button--reddit" href="https://reddit.com/submit/?url=<?php echo urlencode(get_the_permalink()); ?>&amp;resubmit=true&amp;title=<?php echo urlencode(get_the_title()); ?>" target="_blank" rel="noopener" aria-label="Reddit">
		  <div class="resp-sharing-button resp-sharing-button--medium"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
		...
		<a class="resp-sharing-button__link resp-sharing-button--email" href="mailto:?subject=<?php echo urlencode(get_the_title()); ?>&amp;body=<?php echo urlencode(get_the_permalink()); ?>" target="_self" rel="noopener" aria-label="E-Mail">
		  <div class="resp-sharing-button resp-sharing-button--medium"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
