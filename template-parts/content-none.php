...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'kaya' ); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		elseif ( is_search() ) : ?>
			...
			<p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'kaya' ); ?></p>
			<?php
				get_search_form();
